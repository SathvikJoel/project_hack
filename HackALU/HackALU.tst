...
output-list x%B1.16.1  y%B1.16.1  zx%B1.1.1 nx%B1.1.1 zy%B1.1.1 ny%B1.1.1 f%B1.1.1 zr%B1.1.1 ng%B1.1.1 ;
...
set x%B0010010100100101  , set y%B0101 0101 0101 1101 , set zx%B0 , set nx%B0, set zy%B1 , set ny%B1 , set f%B0  , set no%B1 ,
eval , 
output;
...
set x%B0101001010000101  , set y%B0101 0101 0010 0000 , set zx%B0 , set nx%B0 , set zy%B1 , set ny%B1 , set f%B1  , set no%B1 ,
eval , 
output;
